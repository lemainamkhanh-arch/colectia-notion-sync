...
== 1.43.3 ==
* Hotfix: bỏ redirect My Account gốc gây vòng lặp tải trang trên endpoint tùy chỉnh.
* Vẫn giữ Trang tài khoản ẩn khỏi menu.

== 1.43.2 ==
* Bỏ Trang tài khoản khỏi menu My Account.
* Điều hướng My Account gốc, Đơn hàng và Downloads về Dự án.

== 1.43.1 ==
* Vật liệu liên quan chỉ lấy trong cùng Bộ sưu tập vật liệu.
* Tăng khoảng cách phần Vật liệu liên quan; đổi Natural Stone thành Đá tự nhiên.
* Chuẩn hóa font và kích thước nút Xuất Moodboard theo nút Xuất yêu cầu báo giá.
