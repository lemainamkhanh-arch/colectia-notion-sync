...
class Colectia_Notion_Sync {
	...
	const PLUGIN_VERSION = '1.41.5'; // Tăng số này để buộc đồng bộ lại toàn bộ, kể cả trang không đổi
...
public function render_moodboard_print_view() {
    if(empty($_GET['cns_export_moodboard'])||!function_exists('is_account_page')||!is_account_page()||!function_exists('is_wc_endpoint_url')||!is_wc_endpoint_url('moodboard')){return;}
