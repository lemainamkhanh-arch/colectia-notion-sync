...
class Colectia_Notion_Sync {
	...
	const PLUGIN_VERSION = '1.42.7'; // Tăng số này để buộc đồng bộ lại toàn bộ, kể cả trang không đổi
...
<?php }
	...
	public function project_quote_button() { if(!function_exists('WC')||!WC()->cart||WC()->cart->is_empty())return;$url=add_query_arg('cns_export_project_quote','1',wc_get_cart_url());echo '<a class=checkout-button target=_blank rel=noopener href='.esc_url($url).'>XUẤT YÊU CẦU BÁO GIÁ</a>'; }
