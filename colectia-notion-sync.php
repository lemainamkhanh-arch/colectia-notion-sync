...
class Colectia_Notion_Sync {
	...
	const PLUGIN_VERSION = '1.42.2'; // Tăng số này để buộc đồng bộ lại toàn bộ, kể cả trang không đổi
